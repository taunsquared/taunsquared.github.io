---
title: "How *The First VIRS* lost its funding"
permalink: /VIRS/funding
excerpt: 
categories:
  - open-lab-notebook
  - thesis
...
I immediately shared [the project's github repository](https://github.com/taunsquared/graphic-novel-thesis){:target="_blank"} where I had been writing the story script and documenting the project. I also linked the directors to [the dropbox folders containing all of the illustrated content created thus far](https://www.dropbox.com/sh/zi8mba9pitiy0pg/AABbcsxk666imF8FsFtxRtEia?dl=0){:target="_blank"}, which was already a substantial portion of the complete work. I wrote a detailed justification for every item listed in the budget, explaining why I chose to work with so many artists, and how this unusually large collaboration required extra design work in order to coordinate visual elements across so many artistic styles. My advisor also spoke to them in person, hoping to make clear how this project fits into his research vision and my thesis work of developing diverse tools and strategies for studying minds and making neuroscience reserach more accessible. 
