...
The following documentation of this project is distilled into an academic paper titled ["An experimental method for evoking and characterizing dynamic color patterning of cuttlefish during prey capture" (2022)](/assets/files/jbm-9-2-e161.pdf).
...
{% include video provider="youtube" id="G3Xx_AnrMyw" %}
