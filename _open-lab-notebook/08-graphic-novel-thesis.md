...
{% include figure image_path="/assets/images/openLabNotebook/TheFirstVIRS/ACB-images.png" max-width="200 px" alt="Anncharlott Berglar" caption="Anncharlott Berglar: Scientific Diagram 4 Illustrator and Colourist" %}
