...
Danbee Kim, Kendra Buresch, Roger Hanlon, Adam R. Kampff (in press). ``An experimental method for evoking and characterizing dynamic color patterning of cuttlefish during prey capture''. \emph{Journal of Biological Methods}.
...
\entry
	...
	\begin{itemize}
		\item Multidisciplinary Master's degree focused on understanding and designing performances and interactive experiences
	\end{itemize}
	}
%------------------------------------------------
\entry
