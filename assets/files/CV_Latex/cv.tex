...
%To develop interactive and empowering methods for neuroscience in increasingly ecologically valid settings. \\
%\textbf{Storytelling for Science Literacy}\\
To create interactive, empowering, and accessible experiences that nuture a global scientific literacy. 
...
\section{publications and exhibits \emph{\small (selected works)}}
...
\section{experience \emph{\small (continued on next page)}}
...
\begin{entrylist}
  \entry
	...
	\begin{itemize}
		...
		\item Prepare and deliver engaging curricula for a diverse range of audiences
		\item Establish and nurture collaborations across areas of expertise
		\item Provide managerial support and administrative assistance to the Director
	\end{itemize}
	}
%------------------------------------------------
\entry
...
\begin{itemize}
	...
	\item Translated neuroscience curriculum into online coursework and organized online classroom experience for remote edition in 2021
	\item Developed and delivered an additional short course for 2021 edition that combined neuroscience theory with speculative fiction and collective improvisational storytelling
\end{itemize}
}
%------------------------------------------------
\entry
...
{\emph{Teacher and Staff}
\begin{itemize}
	\item Prepare and deliver curriculum in multi-age (8-18 years old) classrooms
	\item Past classes: Neural Cell Diversity, Fermentation Fun, Ropework \& Knots, Jugger, Quidditch
\end{itemize}
}
%------------------------------------------------
\end{entrylist}
...
\begin{itemize}
	...
	\item participated as a student in \href{http://web.mit.edu/12.000/www/m2009/finalwebsite/}{Mission 2009: The Tsunami Threat to the Pacific}
	...
	\item served as an alumni mentor since 2021
\end{itemize}
}
%------------------------------------------------
\entry
